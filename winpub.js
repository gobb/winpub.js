...
(function () { 'use strict'
  ...
  window.winpub = {
    ...
    getAllSnapshots: function getAllSnapshots(options) {
      var results = []
      var now = new Date() * 1
      ...
      createPublisher: function createPublisher(options) {
        ...
        function ensureRunning() {
          if(!running) throw 'cannot call publish() after stop() has been called on the publisher'
        }
